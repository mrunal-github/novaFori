package com.novafori.propertyreader;

import java.io.FileInputStream;
import java.util.Properties;

/**This file (config.properties) stores the information that remains static throughout the framework
         ...
         URL, Login Credentials are kept in the config.properties file.
